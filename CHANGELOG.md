...
- Lifecycle manager for servers, workers, and cleanup functions.
- Sequential reverse-order and parallel shutdown modes.
- Signal, context, component-exit, and timeout handling.
